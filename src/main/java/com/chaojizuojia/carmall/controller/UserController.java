package com.chaojizuojia.carmall.controller;

import com.alibaba.fastjson.JSONObject;
import com.chaojizuojia.carmall.service.UserService;
...
public class UserController {
    ...
    public JSONObject addUser(@RequestBody JSONObject requestJson) {
        ...
        requestJson.put("password", PasswordUtils.encryptPassword(requestJson.getString("password")));
    ...
    public JSONObject updateUser(@RequestBody JSONObject requestJson) {
        CommonUtil.hasAllRequired(requestJson, " nickname, roleIdsStr, deleteStatus, userId");
