...
import com.chaojizuojia.carmall.dao.UserDao;
import com.chaojizuojia.carmall.service.UserService;
import com.chaojizuojia.carmall.util.CommonUtil;
import com.chaojizuojia.carmall.util.constants.ErrorEnum;
...
public class UserServiceImpl implements UserService {
    ...
    public JSONObject listUser(JSONObject jsonObject) {
        ...
        for( JSONObject  jsonobject : list)
        {
        	...
        	List<String> roleNameList = userDao.listRoleName(ids);
        	jsonobject.put("roleName", roleNameList);
        }
